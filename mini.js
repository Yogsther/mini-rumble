 ...
 */
 ...
 var carrotCatch = {
     ...
     init: function(dif){
         ...
         this.carrotPosition = {x: 677, y: 205};
         this.rabbitScale = .7;
         this.carrotScale = .3;
 ...
 var mash = {
     ...
     spawnParticle: function(){
        ...
        this.particles.push({progress: 0, color: particleColors[Math.floor(Math.random()*particleColors.length)], goLeft: goLeft, punch: Math.floor(Math.random()*50)});
     }
 }

 
 var miniGames = [mash, carrotCatch]